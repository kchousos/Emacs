...
#+begin_src emacs-lisp :tangle ./init.el
  (defun set-font-faces ()
        ...
        (set-face-attribute 'default nil :font "Iosevka" :weight 'regular :height 140)
        (set-face-attribute 'fixed-pitch nil :font "Iosevka" :weight 'regular :height 130)
        (set-face-attribute 'variable-pitch nil :font "Iosevka Aile" :weight 'regular :height 140))
...
(setq org-export-backends '(md latex html))
