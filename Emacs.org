...
#+begin_src emacs-lisp :tangle ./init.el
  (use-package org
    :elpaca (:type git :repo "https://git.tecosaur.net/tec/org-mode.git" :branch "dev")
...
(use-package engrave-faces
  ...
  ;; (add-to-list 'org-latex-engraved-options '("frame" "false"))
...
(use-package dired-delight
  :elpaca (:host github :repo "karthink/dired-delight")
...
(use-package pomm
  ...
  (setq alert-default-style 'libnotify
        ...
        pomm-audio-files '((work . "~/.config/emacs/clock.wav")
                           (tick . "~/.config/emacs/clock.wav")
                           (short-break . "~/.config/emacs/clock.wav")
                           (break . "~/.config/emacs/clock.wav")
                           (long-break . "~/.config/emacs/clock.wav")
                           (stop . "~/.config/emacs/clock.wav")))
  (pomm-mode-line-mode))
#+end_src
