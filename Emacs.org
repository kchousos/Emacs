...
#+begin_src emacs-lisp :tangle ./init.el
  (use-package org
    :elpaca (:type git :repo "https://git.tecosaur.net/tec/org-mode.git")
...
(use-package org-analyzer
  :elpaca (:host github
                 ...
                 :files (:defaults "org-analyzer-el/*")))
#+end_src
...
(autoload 'eclipse-mode "/home/kchou/.config/emacs/elpaca/build/eclipse/eclipse.el" "ECLIPSE editing mode" t)
