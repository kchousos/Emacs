...
#+begin_src emacs-lisp :tangle ./init.el
  (defun set-font-faces ()
        ...
        (set-face-attribute 'default nil :font "Iosevka" :weight 'regular :height 130)
        (set-face-attribute 'fixed-pitch nil :font "Iosevka" :weight 'regular :height 130)
        (set-face-attribute 'variable-pitch nil :font "Iosevka Aile" :weight 'regular :height 130))
...
(setq org-hugo-base-dir (expand-file-name "~/Repos/test-site"))
#+end_src
...
(use-package dashboard
  ...
  :config
  ;; Set the banner
  (setq dashboard-startup-banner "~/.config/emacs/logos/gnu-emacs.svg")
  ;; Value can be
...
(setq xenops-math-latex-process-alist
      '(
       (dvisvgm :programs
                ...
                :latex-compiler
                ("lualatex -no-pdf -interaction=nonstopmode -shell-escape -output-directory %o %f")
                :image-converter
