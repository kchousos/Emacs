...
#+begin_src emacs-lisp :tangle ./init.el
(global-set-key (kbd "M-<f5>") #'(lambda () (interactive) (setq mode-line-format nil)))
#+end_src
...
(use-package org-roam
  ...
  (org-roam-capture-ref-templates
   '(("r" "ref" plain "%?"
      :if-new (file+head "references/${slug}.org" "#+title: ${title}#+date: %U\n\n")
      :unnarrowed t)))
